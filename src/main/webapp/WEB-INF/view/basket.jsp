                            ...
                            <div class="row">
                                <div class="col-lg-10 offset-lg-1">
                                    <div class="cart_container">
                                        <div class="cart_title">Alışveriş Sepeti<small> <b class="ml-3"> (  ${fn:length(basketProducts)} Sepetteki Ürünler )</b> </small></div>
                                                    ...
                                                    <li class="cart_item clearfix">
                                                        ...
                                                        <div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">
                                                            ...
                                                            <div class="cart_item_total cart_info_col">
                                                                <div class="cart_item_title">Markası</div>
                                                                <div class="cart_item_text text-left">${product.brand} </div>
                                                            </div>

                                                            <div class="cart_item_total cart_info_col">
                                                                <div class="cart_item_title">Fiyatı</div>
                                                                <div class="cart_item_text">${product.price} &#x20BA;</div>
                                                            </div>

                                                            <div class="cart_item_total cart_info_col">
                                                                <a href="/user/deleteItem/${product.id}" class="cart_item_title text-danger">Sil</a>
                                                            </div>
                                        ...
                                        <div class="order_total">
                                            <div class="order_total_content text-md-right">
                                                <div class="order_total_title">Sipariş Toplamı :</div>
                                        ...
                                        <c:if test="${not empty basketProducts}">
                                            <div class="cart_buttons">
                                                ...
                                                <a href="/user/destroy" type="button" class="button cart_button_clear">Sepeti Boşalt</a>
                                                <a href="/user/sellProduct" type="button" class="button cart_button_checkout">Siparişi Onayla</a> </div>
                                        </c:if>
